...
public abstract class ActivityEditAccountBinding extends ViewDataBinding {
  ...
  protected ActivityEditAccountBinding(Object _bindingComponent, View _root, int _localFieldCount,
      MaterialAutoCompleteTextView accountJid, TextInputLayout accountJidLayout,
      ...
      ImageButton actionDeletePgp, ImageButton actionEditYourName,
      ImageButton actionRegenerateAxolotlKey, AppBarLayout appBarLayout, RoundedImageView avater,
      LinearLayout axolotlActions, TextView axolotlFingerprint,
      RelativeLayout axolotlFingerprintBox, RelativeLayout buttonBar, Button cancelButton,
      Button clearDevices, MaterialCardView editor, EditText hostname,
      TextInputLayout hostnameLayout, LinearLayout namePort, MaterialCardView osOptimization,
      TextView osOptimizationBody, Button osOptimizationDisable, TextView osOptimizationHeadline,
      LinearLayout otherDeviceKeys, MaterialCardView otherDeviceKeysCard,
      TextView otherDeviceKeysTitle, TextView ownFingerprintDesc, TextView pgpFingerprint,
      RelativeLayout pgpFingerprintBox, TextView pgpFingerprintDesc, EditText port,
      TextInputLayout portLayout, TableRow pushRow, Button saveButton, Button scanButton,
      ...
      TextView serverInfoSm, TextView sessionEst, ImageButton showQrCodeButton,
      MaterialCardView stats, MaterialToolbar toolbar, LinearLayout unverifiedWarning,
      TextView yourName, RelativeLayout yourNameBox, TextView yourNameDesc) {
