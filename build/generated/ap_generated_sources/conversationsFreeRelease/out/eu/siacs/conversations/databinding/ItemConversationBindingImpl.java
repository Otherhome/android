...
public class ItemConversationBindingImpl extends ItemConversationBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.message_status, 9);
        sViewsWithIds.put(R.id.notification_status, 10);
        sViewsWithIds.put(R.id.pinned_on_top, 11);
        sViewsWithIds.put(R.id.unread_count, 12);
        sViewsWithIds.put(R.id.conversation_lastupdate, 13);
    }
    // views
    @NonNull
    ...
    private ItemConversationBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (eu.siacs.conversations.ui.widget.UnreadCountCustomView) bindings[12]
            );
