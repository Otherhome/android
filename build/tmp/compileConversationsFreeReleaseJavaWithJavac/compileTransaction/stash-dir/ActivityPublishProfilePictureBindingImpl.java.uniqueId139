...
public class ActivityPublishProfilePictureBindingImpl extends ActivityPublishProfilePictureBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.account_image_wrapper, 3);
        sViewsWithIds.put(R.id.account_image, 4);
        sViewsWithIds.put(R.id.hint, 5);
        sViewsWithIds.put(R.id.secondary_hint, 6);
        sViewsWithIds.put(R.id.hint_or_warning, 7);
        sViewsWithIds.put(R.id.button_bar, 8);
        sViewsWithIds.put(R.id.cancel_button, 9);
        sViewsWithIds.put(R.id.publish_button, 10);
    }
    // views
    @NonNull
