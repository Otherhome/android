...
public class ActivityTrustKeysBindingImpl extends ActivityTrustKeysBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.key_error_message_card, 3);
        sViewsWithIds.put(R.id.key_error_message_title, 4);
        sViewsWithIds.put(R.id.key_error_message, 5);
        sViewsWithIds.put(R.id.key_error_general, 6);
        sViewsWithIds.put(R.id.key_error_hint_mutual, 7);
        sViewsWithIds.put(R.id.disable_button, 8);
        sViewsWithIds.put(R.id.own_keys_card, 9);
        sViewsWithIds.put(R.id.own_keys_title, 10);
        sViewsWithIds.put(R.id.own_keys_details, 11);
        sViewsWithIds.put(R.id.foreign_keys, 12);
        sViewsWithIds.put(R.id.button_bar, 13);
        sViewsWithIds.put(R.id.cancel_button, 14);
        sViewsWithIds.put(R.id.save_button, 15);
    }
    // views
    @NonNull
